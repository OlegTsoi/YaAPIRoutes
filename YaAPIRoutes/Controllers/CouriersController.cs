...
namespace YaAPIRoutes.Controllers
{
    public class CouriersController : Controller
    {
        private readonly YaAPIRoutesContext _context;

        public CouriersController(YaAPIRoutesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Venicle_Id,Routejson")] Courier courier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Venicle_Id,Routejson")] Courier courier)
        {
            if (id != courier.Id)
            {
                return NotFound();
